...
const addRecord = function (visitTimeStamp, username, email, callback) {
  let queryScript = `INSERT INTO orders (visitTimeStamp, username, email) VALUES (?, ?, ?);`;
  connection.query(queryScript, [visitTimeStamp, username, email], callback);
}
...
addRecord("Wed Jul 11 2018", "jens_leerssen", 'notarealaccount@gmail', function(e,s){
  if (e) {
